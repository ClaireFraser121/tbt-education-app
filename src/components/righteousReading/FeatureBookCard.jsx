...
const FeatureBookCard = () => {
  return (
    <div className="hero-section bg-gradient-to-r from-green-800 via-green-600 to-green-400 text-white p-8 mb-8 flex flex-col-reverse md:flex-row justify-between items-center">
      <div className="w-full md:w-1/2">
        <h2 className="text-4xl font-bold mb-4 md:ml-20">Freestyle Saga - Part One</h2>
        <div className="text-description mt-10 md:ml-20 md:mr-10">
          <p>
        ...
        <a href="https://2badda.com/products/freestyle-saga-part-one" className="block" target="_blank" rel="noopener noreferrer">
          <button className="bg-yellow-400 hover:bg-green-400 text-white font-bold py-2 px-4 rounded mt-10 md:ml-20">
            Get Book
          </button>
        </a>
      </div>
